"""
Django settings for Kirov2 project.
...
SECRET_KEY = 'django-insecure-cc=jm-*dbr_2lqvmwe4fhhy7ex61ktbf2dc%k7&mhz(5f5f)40'
...
WSGI_APPLICATION = 'Kirov2.wsgi.application'
...
print('Путь к папке MEDIA:', MEDIA_ROOT)
